...
# Channel Map: A0 = Humidity, A1 = MQ Gas (AQI/PPM), A3 = Sound (dB)
# ==============================================================================
FORCE_MOCK_SENSORS = os.environ.get("FORCE_MOCK_SENSORS", "False").lower() == "true"

ADS1115_GAIN = 1
HUMIDITY_CHANNEL = int(os.environ.get("HUMIDITY_CHANNEL", "0"))  # A0: Local Humidity (% RH)
MQ_CHANNEL = int(os.environ.get("MQ_CHANNEL", "1"))              # A1: MQ Gas Sensor (AQI / PPM)
SOUND_CHANNEL = int(os.environ.get("SOUND_CHANNEL", "3"))        # A3: Sound / Noise Sensor (Decibel dB)

MQ_CLEAN_AIR_RO = 10.0
SOUND_V_REF = 0.005
SOUND_DB_OFFSET = 45.0

# Direct GPIO Pins (Fallback if ADC not used)
DHT_PIN = int(os.environ.get("DHT_PIN", "4"))
DHT_TYPE = int(os.environ.get("DHT_TYPE", "11"))
SMOKE_PIN = int(os.environ.get("SMOKE_PIN", "11"))
SMOKE_ACTIVE_LOW = os.environ.get("SMOKE_ACTIVE_LOW", "True").lower() == "true"
MIC_PIN = int(os.environ.get("MIC_PIN", "13"))
MIC_ACTIVE_LOW = os.environ.get("MIC_ACTIVE_LOW", "True").lower() == "true"
