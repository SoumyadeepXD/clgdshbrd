...
class WeatherScreen:
    """
    Screen 2: Full-Screen Weather View of Kolkata New Town.
    Maximized container filling 95% of the display.
    """
    ...
    def draw(self, weather_data: dict):
        ...
        self.surface.blit(city_surf, (card_rect.centerx - city_surf.get_width() // 2, card_rect.top + int(card_h * 0.06)))
        ...
        self.surface.blit(cond_surf, (card_rect.centerx - cond_surf.get_width() // 2, card_rect.top + int(card_h * 0.68)))
        ...
        self.surface.blit(hi_lo_surf, (card_rect.centerx - hi_lo_surf.get_width() // 2, card_rect.top + int(card_h * 0.82)))
